 ...
 */
final class Version20240619100953 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commandes (id INT AUTO_INCREMENT NOT NULL, id_util_id INT NOT NULL, INDEX IDX_35D4282C11C087F0 (id_util_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, nom_prod VARCHAR(50) NOT NULL, description_prod VARCHAR(255) NOT NULL, prix_prod DOUBLE PRECISION NOT NULL, stock INT NOT NULL, disponibilite SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
